...
namespace JustAnotherNight.Basic;
...
public partial class Player : AnimatedEntity
{
	...
	/// </summary>
	[Net, Predicted]
	public BasicController Controller { get; set; }

	/// <summary>
	/// This is used for noclip mode
	/// </summary>
	[Net, Predicted]
	public BasicController DevController { get; set; }
	...
	/// <summary>
	/// Player's inventory for entities that can be carried. See <see cref="Carriable"/>.
	/// </summary>
	...
	/// </summary>
	public virtual BasicController GetActiveController()
	{
